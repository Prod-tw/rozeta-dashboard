...
- While active, the desired meeting must be the account's only meeting in the complete paginated `GET /api/v1/meetings?status=in_progress` result. Observe every five seconds and immediately after commands.
